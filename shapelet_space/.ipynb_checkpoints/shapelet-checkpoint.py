...
def set_parameters(length, num, array):
    global Shapelet_length, Number_of_shapelets, shapelet_array
    Shapelet_length = length
    Number_of_shapelets = num
    shapelet_array = array
